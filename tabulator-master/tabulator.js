 ...
 (function(){
	...
	_buildElement: function(){
		...
		if(options.pagination){
			...
			//######################ADDED PRINT BUTTON. EDITED CSS TO LEFT ALIGN PRINT BUTTON.
			self.paginator = $("<span class='tabulator-paginator'><span class='tabulator-page' id='print' data-page='print' role='button' aria-label='Print Page'>Print</span><span class='tabulator-page' data-page='first' role='button' aria-label='First Page'>First</span><span class='tabulator-page' data-page='prev' role='button' aria-label='Previous Page'>Prev</span><span class='tabulator-pages'></span><span class='tabulator-page' data-page='next' role='button' aria-label='Next Page'>Next</span><span class='tabulator-page' data-page='last' role='button' aria-label='Last Page'>Last</span></span>");
	...
	setPage:function(page){
		...
		if(page > 0 && page <= self.paginationMaxPage){
			...
			switch(page){
				...
				//###########IF PRINT CASE, GET PRINTABLE PAGE
				case "print":
